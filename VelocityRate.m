    ...
    for mm = 1:MonteCalo
        ...
        if methods(2) == 1
            ...
            for nn = 1:(Tindex-Startindex)
                ...
                Rate(vec,2) = Rate(vec,2) + log2(1+snr/para.N*far_field_rate_gain);
            end
        ...
        if methods(3) == 1
            for nn = 1:(Tindex-Startindex)
                ...
                Rate(vec,3) = Rate(vec,3) + log2(1+snr/para.N* PerfCSIgain);
            end
        end
        if methods(4) == 1
        ...
        if methods(7) == 1
            ...
            for nn = 1:Tindex-Startindex
                ...
                Rate(vec,7) = Rate(vec,7) + log2(1+PerfCSIgain/SigmaN);
            end
        end
    end
